        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="hover:text-blue-600">News & Blogs</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="hover:text-blue-600">Papers</Link></li>
              <li><Link href="#" className="hover:text-blue-600">Press Conferences</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                <span className="mr-2">📍</span>
                <span>Address: 123 Learning Street, Knowledge City, EduCountry</span>
              </li>
            </ul>
          </div>
        </div>
