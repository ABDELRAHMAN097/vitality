...
export const About = () => {
  return (
    ...
    >
      <div className="absolute top-0 left-0 w-80 h-80 bg-blue-200 opacity-50 rounded-full blur-3xl z-20"></div>
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-blue-200 opacity-50 rounded-full blur-3xl z-20"></div>
      <div className="flex flex-col md:flex-row items-center justify-center px-4 w-full relative z-50">
        ...
        <div className="w-full flex flex-col gap-5 md:gap-10 relative z-50">
          <h2 className="text-[#190C71] text-center md:text-start font-semibold text-xl md:text-5xl relative z-50">
